...
variable "computed_members_map" {
  ...
  validation {
    condition     = alltrue([for key, value in var.computed_members_map : can(regex("^(user|serviceAccount|group|domain):", value))])
    error_message = "Each member can have one of the following values: `user:`, `serviceAccount:`, `group:` or `domain:`."
  }
}
